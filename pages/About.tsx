      ...
      <section className="py-24 bg-white dark:bg-gray-900 transition-colors duration-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {[
              { name: 'Hafsa Assefri', role: t.aboutPage.team.founder, img: getCloudinaryUrl('Creator-1', { width: 800, quality: 'auto', format: 'auto' }) },
              { name: 'El habib Assefri', role: t.aboutPage.team.headDesigner, img: getCloudinaryUrl('Creator-2', { width: 800, quality: 'auto', format: 'auto' }) }
            ].map((member, i) => (
